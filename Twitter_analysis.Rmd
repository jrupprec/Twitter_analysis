...
rt_model <- glm(retweet_count ~ followers_count + statuses_count + friends_count + mean_sentiment_party + mean_sentiment_tweet + no_hashtags + no_mentions, family = "poisson", data = complete_df)
...
```{r fitted values}
data_tweets_test$pred.retweet_count <- round(predict(rt_model, newdata = data_tweets_test, type = "response"))
```
